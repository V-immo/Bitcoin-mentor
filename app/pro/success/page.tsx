    ...
    <div className="pro-page">
      <div className="pro-success-card">
        ...
        <p className="pro-success-text">
          {isNL
            ? "Je betaling is bevestigd. Alle PRO-functies zijn nu actief — curriculum niveau 3–10, onbeperkte coaching, Live Ready certificaat."
            : "Your payment is confirmed. All PRO features are now active — curriculum levels 3–10, unlimited coaching, Live Ready certificate."}
        </p>
